package com.ainutribox.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.ainutribox.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
