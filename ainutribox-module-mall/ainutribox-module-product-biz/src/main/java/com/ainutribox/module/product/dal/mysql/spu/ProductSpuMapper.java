package com.ainutribox.module.product.dal.mysql.spu;
...
import com.ainutribox.module.product.enums.ProductConstants;
...
public interface ProductSpuMapper extends BaseMapperX<ProductSpuDO> {
     ...
     */
    default void updateSalesCount(Long id, Integer count) {
        LambdaUpdateWrapper<ProductSpuDO> updateWrapper = new LambdaUpdateWrapper<ProductSpuDO>()
                .setSql(" sales_count = sales_count + " + count)
                .eq(ProductSpuDO::getId, id);
        update(null, updateWrapper);
    }
}
