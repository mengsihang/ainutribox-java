...
import com.ainutribox.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "小泉山")
    private String name;
    ...
    @Schema(description = "商品每日最大摄入量")
    private Integer limitNum;

    @Schema(description = "英文名字")
