package com.ainutribox.module.promotion.dal.mysql.banner;
...
public interface BannerMapper extends BaseMapperX<BannerDO> {
    ...
    default List<BannerDO> selectBannerListByPosition(Integer position) {
        return selectList(new LambdaQueryWrapperX<BannerDO>().eq(BannerDO::getPosition, position).eq(BannerDO::getStatus,0));
    }
