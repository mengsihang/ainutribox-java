package com.ainutribox.module.trade.service.price.calculator;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.ainutribox.module.promotion.api.coupon.CouponApi;
...
import com.ainutribox.module.trade.enums.order.TradeOrderTypeEnum;
...
import static com.ainutribox.module.promotion.enums.ErrorCodeConstants.COUPON_NO_MATCH_MIN_PRICE;
import static com.ainutribox.module.promotion.enums.ErrorCodeConstants.COUPON_NO_MATCH_SPU;
import static com.ainutribox.module.trade.enums.ErrorCodeConstants.PRICE_CALCULATE_COUPON_NOT_MATCH_NORMAL_ORDER;
...
public class TradeCouponPriceCalculator implements TradePriceCalculator {
    ...
    private Integer getCouponPrice(CouponRespDTO coupon, Integer totalPayPrice) {
        if (PromotionDiscountTypeEnum.PRICE.getType().equals(coupon.getDiscountType())) { // 减价
            ...
            int couponPrice = totalPayPrice * (100-coupon.getDiscountPercent()) / 100;
