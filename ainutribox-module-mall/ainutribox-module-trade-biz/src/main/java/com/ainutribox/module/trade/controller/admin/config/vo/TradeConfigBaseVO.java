package com.ainutribox.module.trade.controller.admin.config.vo;
...
public class TradeConfigBaseVO {
    ...
    @Schema(description = "分销海报图地址数组", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.iocoder.cn/ainutribox.jpg]")
    ...
    // ========== 代理商相关 ==========
    @Schema(description = "代理商返佣比例", requiredMode = Schema.RequiredMode.REQUIRED)
    private Integer brokerageSupplierPercent;
    // ========== 营养师相关 ==========
    @Schema(description = "营养师返佣比例", requiredMode = Schema.RequiredMode.REQUIRED)
    private Integer brokerageDietitionPercent;
