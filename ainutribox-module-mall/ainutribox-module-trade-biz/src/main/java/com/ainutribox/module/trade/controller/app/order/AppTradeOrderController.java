package com.ainutribox.module.trade.controller.app.order;
...
public class AppTradeOrderController {
    ...
    @PreAuthenticated
    public CommonResult<AppTradeOrderCreateRespVO> createOrder(@RequestBody Map<String, Object> orderMap) {

        AppTradeOrderCreateReqVO createReqVO = tradeOrderUpdateService.conversionOrder(orderMap);
