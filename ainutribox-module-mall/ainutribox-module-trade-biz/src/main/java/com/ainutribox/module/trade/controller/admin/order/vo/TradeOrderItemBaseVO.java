package com.ainutribox.module.trade.controller.admin.order.vo;
...
public class TradeOrderItemBaseVO {
    ...
    @Schema(description = "商品 SPU 名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "河南小泉山科技")
    ...
    // ========== 营销基本信息 ==========
    @Schema(description = "营养师名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "河南小泉山科技")
    private String dietitianName;

    @Schema(description = "营养师手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "河南小泉山科技")
    private String dietitianPhone;

    @Schema(description = "是否还有咨询", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
