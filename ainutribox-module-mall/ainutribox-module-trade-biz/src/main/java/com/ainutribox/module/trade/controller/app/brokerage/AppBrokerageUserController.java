package com.ainutribox.module.trade.controller.app.brokerage;
...
import com.ainutribox.module.trade.controller.app.brokerage.vo.user.*;
...
import com.ainutribox.module.trade.enums.brokerage.BrokerageWithdrawStatusEnum;
import com.ainutribox.module.trade.service.brokerage.BrokerageRecordService;
import com.ainutribox.module.trade.service.brokerage.BrokerageUserService;
import com.ainutribox.module.trade.service.brokerage.BrokerageWithdrawService;
import com.ainutribox.module.trade.service.brokerage.bo.BrokerageWithdrawSummaryRespBO;
...
public class AppBrokerageUserController {
    ...
    public CommonResult<AppBrokerageUserMySummaryRespVO> getBrokerageUserSummary() {
        ...
        if (Objects.isNull(brokerageUser)) {
            return success(new AppBrokerageUserMySummaryRespVO());
        }
        // 统计用户昨日的佣金
        ...
        // 拼接返回
        return success(BrokerageUserConvert.INSTANCE.convert(yesterdayPrice, withdrawPrice, firstBrokerageUserCount, 0L, brokerageUser));
    }
