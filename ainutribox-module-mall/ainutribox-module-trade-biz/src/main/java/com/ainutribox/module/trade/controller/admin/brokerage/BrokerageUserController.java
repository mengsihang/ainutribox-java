package com.ainutribox.module.trade.controller.admin.brokerage;
...
import com.ainutribox.module.trade.controller.admin.brokerage.vo.user.*;
...
public class BrokerageUserController {
    ...
    public CommonResult<PageResult<BrokerageUserRespVO>> getBrokerageUserPage(@Valid BrokerageUserPageReqVO pageVO) {
        ...
        if(ObjectUtil.isNull(pageVO.getLevel())){
            pageVO.setLevel(1);
        }
        ...
        Map<Long, Long> brokerageUserCountMap = convertMap(userIds,
                userId -> userId,
                userId -> brokerageUserService.getBrokerageUserCountByBindUserId(userId, pageVO.getLevel()));
        // 合计分佣的提现
