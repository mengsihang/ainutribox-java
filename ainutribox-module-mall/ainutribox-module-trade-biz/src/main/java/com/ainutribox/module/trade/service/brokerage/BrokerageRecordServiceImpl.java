package com.ainutribox.module.trade.service.brokerage;
...
import com.ainutribox.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.ainutribox.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import com.ainutribox.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.ainutribox.module.trade.convert.brokerage.BrokerageRecordConvert;
...
import com.ainutribox.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import com.ainutribox.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import com.ainutribox.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
...
import static com.ainutribox.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.ainutribox.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.ainutribox.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.ainutribox.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
...
public class BrokerageRecordServiceImpl implements BrokerageRecordService {
    ...
    public void addBrokerage(Long userId, BrokerageRecordBizTypeEnum bizType, List<BrokerageAddReqBO> list) {
        ...
        MemberUserRespDTO memberUserRespDTO =  memberUserApi.getUser(firstUser.getId());
        Integer percent = memberConfig.getBrokerageFirstPercent();
        if(memberUserRespDTO.getMemberType() == 1){
            percent = memberConfig.getBrokerageSupplierPercent();
        } else if (memberUserRespDTO.getMemberType() == 2) {
            percent = memberConfig.getBrokerageDietitionPercent();
        }

        // 1.2 计算一级分佣
        addBrokerage(firstUser, list, memberConfig.getBrokerageFrozenDays(), percent,
                bizType, 1);
