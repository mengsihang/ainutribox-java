package com.ainutribox.module.trade.controller.admin.config;

import com.ainutribox.framework.common.pojo.CommonResult;
import com.ainutribox.module.trade.controller.admin.config.vo.TradeConfigRespVO;
import com.ainutribox.module.trade.controller.admin.config.vo.TradeConfigSaveReqVO;
import com.ainutribox.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${ainutribox.tencent-lbs-key}")
