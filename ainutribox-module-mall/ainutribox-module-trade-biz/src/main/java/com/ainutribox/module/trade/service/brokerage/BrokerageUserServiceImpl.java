...
import com.ainutribox.module.trade.controller.admin.brokerage.vo.user.BrokerageUserPageReqVO;
import com.ainutribox.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryPageReqVO;
import com.ainutribox.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserChildSummaryRespVO;
import com.ainutribox.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByUserCountRespVO;
import com.ainutribox.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.ainutribox.module.trade.convert.brokerage.BrokerageUserConvert;
...
import com.ainutribox.module.trade.enums.brokerage.BrokerageBindModeEnum;
...
import static com.ainutribox.framework.common.util.collection.CollectionUtils.convertMapByFilter;
...
public class BrokerageUserServiceImpl implements BrokerageUserService {
    ...
    public PageResult<AppBrokerageUserChildSummaryRespVO> getBrokerageUserChildSummaryPage(AppBrokerageUserChildSummaryPageReqVO pageReqVO, Long userId) {
        ...
        if (pageReqVO.getNickname() == null) {
            // No nickname filter, return all users
            userMap = convertMapByFilter(users, user -> true, MemberUserRespDTO::getId);
        } else {
            // Filter users by nickname
            userMap = convertMapByFilter(users,
