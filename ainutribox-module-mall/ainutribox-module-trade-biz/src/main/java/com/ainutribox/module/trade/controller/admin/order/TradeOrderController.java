package com.ainutribox.module.trade.controller.admin.order;
...
import com.ainutribox.module.trade.service.order.TradeOrderItemService;
import com.ainutribox.module.trade.service.order.TradeOrderLogService;
...
public class TradeOrderController {
    ...
    @PutMapping("/update-dietitian")
    @Operation(summary = "绑定营养师")
    @PreAuthorize("@ss.hasPermission('trade:order:update')")
    public CommonResult<Boolean> updateOrderRemark(@RequestBody TradeOrderItemDO reqVO) {
        tradeOrderItemService.updateOrderItem(reqVO);
        return success(true);
    }
