...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ainutribox.go";
    private static final String ARTIFACT_ID = "ainutribox";
    private static final String PACKAGE_NAME = "com.ainutribox";
    private static final String TITLE = "AInutriBox 管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ainutribox.go";
        String artifactIdNew = "ainutribox";
        String packageNameNew = "com.ainutribox";
        String titleNew = "AInutriBox 管理系统";
        String projectBaseDirNew = "G:\\code\\javacode\\" + artifactIdNew + "-new"; // 一键改名后，“新”项目所在的目录
