package com.ainutribox.module.erp.controller.admin.stock.vo.in;
...
import static com.ainutribox.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "小泉山")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "创建人", example = "小泉山")
    private String creator;
    @Schema(description = "创建人名称", example = "小泉山")
