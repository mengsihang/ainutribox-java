package com.ainutribox.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierSaveReqVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "河南小泉山科技")
