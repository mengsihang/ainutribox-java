 ...
 * @author 小泉山网络科技
 */
@TableName("member_dietition")
@KeySequence("member_dietition_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class DietitionDO extends BaseDO {
