package com.ainutribox.module.member.controller.admin.user;

import cn.hutool.core.collection.CollUtil;
import com.ainutribox.framework.common.pojo.CommonResult;
import com.ainutribox.framework.common.pojo.PageResult;
import com.ainutribox.module.member.controller.admin.user.vo.*;
...
import com.ainutribox.module.member.enums.point.MemberPointBizTypeEnum;
import com.ainutribox.module.member.service.group.MemberGroupService;
import com.ainutribox.module.member.service.level.MemberLevelService;
import com.ainutribox.module.member.service.point.MemberPointRecordService;
import com.ainutribox.module.member.service.tag.MemberTagService;
...
public class MemberUserController {
    ...
    public CommonResult<PageResult<MemberUserRespVO>> getUserPage(@Valid MemberUserPageReqVO pageVO) {
        ...
        //处理推荐人
        List<MemberUserDO> members = memberUserService.getUserList(
                convertSet(pageResult.getList(), MemberUserDO::getMemberId));

        //处理分销商
        List<AdminUserRespDTO> distributors = adminUserApi.getUserList(
                convertSet(pageResult.getList(), MemberUserDO::getDistributorId));

        //处理营养师
        List<AdminUserRespDTO> nutritionS = adminUserApi.getUserList(
                convertSet(pageResult.getList(), MemberUserDO::getNutritionId));

        return success(MemberUserConvert.INSTANCE.convertPage(pageResult, tags, levels, groups,members,distributors,nutritionS));
    }
