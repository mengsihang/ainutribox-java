package com.ainutribox.module.member.controller.app.address;
...
import com.ainutribox.module.member.controller.app.address.vo.AppAddressRespVO;
...
import com.ainutribox.module.member.service.address.AddressService;
...
public class AppAddressController {
    ...
    @GetMapping("/getAiAddress")
    @Operation(summary = "智能解析用户地址")
    @PreAuthenticated
    public CommonResult<Object> getAiAddress(String addressStr) {
        return success(addressService.getAiAddress(addressStr));
    }
