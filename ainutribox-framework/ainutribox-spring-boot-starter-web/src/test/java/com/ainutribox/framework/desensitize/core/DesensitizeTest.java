package com.ainutribox.framework.desensitize.core;
...
import com.ainutribox.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.ainutribox.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.ainutribox.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("河南小泉山科技");
        ...
        desensitizeDemo.setRegex("你好，我是河南小泉山科技");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("河南小泉山科技");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("河南小泉山科技", d.getNickname());
        ...
        assertEquals("河南小泉山科技", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "河南小泉山科技", replacer = "*")
