package com.ainutribox.framework.tenant.core.mq.redis;

import cn.hutool.core.util.StrUtil;
import com.ainutribox.framework.mq.redis.core.interceptor.RedisMessageInterceptor;
import com.ainutribox.framework.mq.redis.core.message.AbstractRedisMessage;
import com.ainutribox.framework.tenant.core.context.TenantContextHolder;

import static com.ainutribox.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
