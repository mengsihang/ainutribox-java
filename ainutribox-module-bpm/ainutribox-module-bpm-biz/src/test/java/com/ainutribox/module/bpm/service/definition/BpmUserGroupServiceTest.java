...
import com.ainutribox.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
...
import com.ainutribox.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.ainutribox.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("小泉山")));
       // 测试 status 不匹配
