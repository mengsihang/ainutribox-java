package com.ainutribox.module.bpm.controller.admin.definition.vo.model;
...
public class BpmModelRespVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_ainutribox")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "小泉山")
    private String name;

    @Schema(description = "流程图标", example = "https://www.iocoder.cn/ainutribox.jpg")
    private String icon;
