package com.ainutribox.module.crm.controller.admin.customer;
...
import com.ainutribox.module.crm.service.customer.CrmCustomerPoolConfigService;
...
public class CrmCustomerController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<CrmCustomerImportExcelVO> list = Arrays.asList(
                CrmCustomerImportExcelVO.builder().name("小泉山").industryId(1).level(1).source(1)
