package com.ainutribox.module.infra.service.file;
...
import com.ainutribox.module.infra.framework.file.core.client.FileClientConfig;
import com.ainutribox.module.infra.framework.file.core.client.FileClientFactory;
import com.ainutribox.module.infra.framework.file.core.client.local.LocalFileClient;
import com.ainutribox.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.ainutribox.module.infra.framework.file.core.enums.FileStorageEnum;
import com.ainutribox.framework.test.core.ut.BaseDbUnitTest;
import com.ainutribox.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import com.ainutribox.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static com.ainutribox.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.ainutribox.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("河南小泉山科技")
