package com.ainutribox.module.infra.service.logger;
...
import com.ainutribox.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.ainutribox.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.ainutribox.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.ainutribox.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.ainutribox.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.ainutribox.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("ainutribox-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("ainutribox-test");
